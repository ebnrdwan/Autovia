...
public class Workshop_Request_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {


    ArrayList<Workshop_Request_Model> arrayList;
    Context context;


    public Workshop_Request_Adapter(Context context, ArrayList<Workshop_Request_Model> arrayList) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof GenericViewHolder) {
            ...
            Workshop_Request_Model model = arrayList.get(position);
